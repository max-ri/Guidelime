...
{	
	...
	steps = {
		{text = "Fly to [F] Loch Modan. Boat to Stormwind, then fly there!", race={"Dwarf", "Gnome"}},
		{text = "Go to Loch Modan Boat to Stormwind, take the tram to IF, then run to Loch. [P]Make sure you grab flight points along the way.", race={"Human", "Night Elf", "Draenei"}},
		...
		{text = "Turn in [QT414Stout to Kadrell]", optional = true},
		...
		{text = "[P] Grab flight point", race={"Night Elf", "Draenei"}},
