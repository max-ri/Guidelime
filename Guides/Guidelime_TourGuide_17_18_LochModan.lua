...
{	
	...
	steps = {
		{text = "Fly to [F Loch Modan]. Boat to Stormwind, then fly there!", race={"Dwarf", "Gnome"}, completeWithNext = true, required = false},
		...
		{text = "Go to Algaz Station In the north of Loch Modan.", completeWithNext = true, required = false},
		...
		{text = "Go to Thelsamar", completeWithNext = true, required = false},
		...
		{text = "Go to The Farstrider Lodge East of Excavation site [G83.8, 62.4]", completeWithNext = true, required = false},
		...
		{text = "Fly to [F City of Ironforge]", race={"Human", "Dwarf", "Gnome"}, completeWithNext = true, required = false},
		{text = "Go to [F City of Ironforge]", race={"Night Elf", "Draenei"}, completeWithNext = true, required = false},
