...
{	
	...
	faction = "Alliance",	
	steps = {
		{text = "Fly to Loch Modan. Boat to Stormwind, then fly there!", race={"Dwarf", "Gnome"}},
		...
		{text = "Go to Algaz Station In the north of Loch Modan. "},
		...
		{text = "Go to The Farstrider Lodge East of Excavation site [L83.8, 62.4]"},
		...
		{text = "Fly to City of Ironforge", race={"Human", "Dwarf", "Gnome"}},
		{text = "Go to City of Ironforge", race={"Night Elf", "Draenei"}},
