...
addon.questsDB[1880].prequests = {}       -- mage lvl 10 quest, seen on my mage
addon.questsDB[1861].prequests = {}       -- mage lvl 10 quest, seen on my mage
addon.questsDB[1302].prequests = {}       -- James Hyal, reported by Branislav
addon.questsDB[691].prequests = {}        -- Worth Its Weight in Gold, reported by Branislav
addon.questsDB[484].prequests = {}        -- Young Crocolisk Skins, reported by Branislav / ahmp(in his guide)
addon.questsDB[4136].prequests = {}       -- Ribbly Screwspigot, reported by Mushroozard
addon.questsDB[5096].prequests = {}       -- Scarlet Diversions, marked as one of but apparently available without any! reported by Mushroozard
addon.questsDB[4134].prequests = {}       -- Lost Thunderbrew Recipe, reported by Mushroozard
addon.questsDB[5082].prequests = {}       -- Threat of the Winterfall, reported by Mushroozard
addon.questsDB[5887].prequests = { 4102 } -- Salve via Hunting, reported by Mushroozard
addon.questsDB[4768].prequests = {}       -- The Darkstone Tablet, reported by Mushroozard
...
addon.questsDB[429].prequests = {}        -- Wild Hearts, reported by Olo
addon.questsDB[1884].prequests = {}       -- Ju-Ju Heaps, reported by Olo (another mage lvl 10)
addon.questsDB[1204].prequests = {}       -- Mudrock Soup and Bugs, reported by Zarant
addon.questsDB[1395].prequests = {}       -- Supplies for Nethergarde, reported by Zarant
addon.questsDB[4126].prequests = {}       -- Hurley Blackbreath, reported by Zarant
addon.questsDB[5149].prequests = {}       -- Pamela's Doll, marked as one of but apparently available without any! reported by Zarant
addon.questsDB[4764].prequests = {}       -- Doomrigger's Clasp, reported by Zarant
addon.questsDB[4734].prequests = {}       -- Egg Freezing, reported by Zarant
addon.questsDB[2518].prequests = {}       -- Tears of the Moon, reported by Zarant
