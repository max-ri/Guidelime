...
L.ERROR_TBC_DATA_SOURCE = "In order to load this guide an additional addon is required as quest data source. Please go to options and select 'Questie' as data source."
...
L["ERROR_TBC_DATA_SOURCE"] = "Um diesen Guide laden zu können ist ein zusätzliches Addon als Quest-Datenquelle erforderlich. Bitte wählen in den Optionen 'Questie' als Datenquelle aus."
