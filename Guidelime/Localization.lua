...
L.SHOW_ETA = "Show ETA"
L.YARDS = "yards"
L.USE_TOMTOM_ARROW = "Use TomTom arrow"
L.USE_TOMTOM_ARROW_TOOLTIP = "Sends the current tracking target to TomTom's own Crazy Arrow\ninstead of showing Guidelime's built-in arrow.\nRequires the TomTom addon to be installed and enabled;\notherwise this option has no effect."
...
L.AUTO_ACCEPT_QUESTS = "Automatically accept quests"
L.AUTO_TURNIN_QUESTS = "Automatically turn in quests"
L.CURRENT_QUESTS = "in current steps"
L.GUIDE_QUESTS = "in current guide"
L.ALL_QUESTS = "all"
L.AUTO_SELECT_FLIGHT = "Automatically select a flight path"
L.AUTO_TRAIN = "Automatically buy spells and skills when the current guide asks for it"
L.EDITOR = "Editor"
...
L.EDITOR_TOOLTIP_LEARN = "The player should learn a spell\ni.e.: \"[LE Arcane Missiles]\""
...
L.ERROR_NPC_NOT_FOUND = "NPC \"%s\" was not found"
...
L.ERROR_FLIGHT_POINT_NOT_FOUND = "Flight point \"%s\" was not found"
L.ZONE = "Zone"
L.LEVEL = "Level"
...
L.DATA_SOURCE_QUESTIE = "Use 'Questie' as data source"
L.DATA_SOURCE_TOOLTIP_QUESTIE = "When the addon 'Questie' is installed, it can be used as data source for quest coordinates.\nIt might contain different information than the internal quest database e.g. for quest mob spawn locations."
L.DATA_SOURCE_CLASSIC_CODEX = "Use 'ClassicCodex' as data source"
L.DATA_SOURCE_TOOLTIP_CLASSIC_CODEX = "When the addon 'ClassicCodex' is installed, it can be used as data source for quest coordinates.\nIt might contain different information than the internal quest database e.g. for quest mob spawn locations."
L.DATA_SOURCE_DB = "Use internal data source"
L.DATA_SOURCE_TOOLTIP_DB = "For information such as quest coordinates only the internal database contained with Guidelime is in use.\nIt might be missing newer quests."
...
L.SHOW_USE_ITEM_BUTTONS = "Show use quest item buttons"
L.MAX_NUM_OF_ITEM_BUTTONS = "Number of item buttons shown\n(0 = unlimited)"
L.SHOW_TARGET_BUTTONS = "Show target NPC buttons"
L.MAX_NUM_OF_TARGET_BUTTONS = "Number of target buttons shown\n(0 = unlimited)"
L.BUTTONS_LEFT = "left of guide window"
L.BUTTONS_RIGHT = "right of guide window"
L.TARGET_RAID_MARKERS = "Set %s on targeted NPC"
L.USE_ITEM_X = "Use item (or cast a spell) %d" -- as in "Use quest item 1" by number for key bindings dialog
L.TARGET_TOOLTIP = "Target %s" -- as in "Target Big Bad Wolf" by name for button tooltip
L.TARGET_X = "Target NPC %d" -- as in "Target NPC 1" by number for key bindings dialog
...
L.WOWHEAD_URL_FOREVER = "https://www.wowhead.com/forever"
L.IMPORT_SETTINGS = "Import character settings"
L.DEFAULT_SETTINGS = "Snapshot these settings for new characters"
...
L["TYPE"] = "类型"
L["URL"] = "地址"
L["DATA_SOURCE_DB"] = "使用内部数据库"
L["DATA_SOURCE_QUESTIE"] = "使用Questie数据库"
L["DATA_SOURCE_TOOLTIP_QUESTIE"] = "若同时启用Questie，可以将之作为任务座标数据库，但它可能会提供与内建数据库不同的数据，例如任务怪的重生点。"
L["DATA_SOURCE_CLASSIC_CODEX"] = "使用ClassicCodex数据库"
L["DATA_SOURCE_TOOLTIP_CLASSIC_CODEX"] = "若同时启用ClassicCodex，可以将之作为任务座标数据库，但它可能会提供与内建数据库不同的数据，例如任务怪的重生点。"
...
L["TYPE"] = "類型"
L["URL"] = "網址"
L["DATA_SOURCE_DB"] = "使用內部資料庫"
L["DATA_SOURCE_QUESTIE"] = "使用Questie資料庫"
L["DATA_SOURCE_TOOLTIP_QUESTIE"] = "若同時啟用Questie，可以將之作為任務座標資料庫，但它可能會提供與內建資料庫不同的資料，例如任務怪的重生點。"
L["DATA_SOURCE_CLASSIC_CODEX"] = "使用ClassicCodex資料庫"
L["DATA_SOURCE_TOOLTIP_CLASSIC_CODEX"] = "若同時啟用ClassicCodex，可以將之作為任務座標資料庫，但它可能會提供與內建資料庫不同的資料，例如任務怪的重生點。"
...
L["ARROW_FONT_SIZE"] = "Richtungspfeil-Schriftgröße"
L["ARROW_GO_TO_INSTANCE"] = "Gehe nach %s"
L["ARROW_POSITION_REACHED"] = "Ziel erreicht"
...
L["BUTTONS_LEFT"] = "links anzeigen"
L["BUTTONS_RIGHT"] = "rechts anzeigen"
L["CURRENT_QUESTS"] = "in aktuellen Schritten"
L["GUIDE_QUESTS"] = "im aktuellen Guide"
...
L["DEFAULT_SETTINGS"] = "Verwende momentane Einstellungen für neue Charaktere"
...
L["EDIT_KEYBINDINGS"] = "Tastaturbelegung bearbeiten"
L["EDITOR"] = "Editor"
...
L["HIDE_MAINFRAME"] = "Fenster verstecken"
L["HIDE_MARKERS_ON"] = "Kartenmarkierungen verstecken auf"
L["Horde"] = "Horde"
...
L["MAX_NUM_OF_TARGET_BUTTONS"] = "Anzahl der Ziel-Knöpfe (0 = unbegrenzt)"
L["MAX_NUM_OF_ITEM_BUTTONS"] = "Anzahl der Gegenstand-Knöpfe (0 = unbegrenzt)"
...
L["OBJECTIVE"] = "Ziel"
L["ONLY_WHEN_MAINFRAME_HIDDEN"] = "nur bei verstecktem Guide-Fenster"
...
L["SHOW_GUIDE_TITLE"] = "Guidetitel anzeigen"
...
L["SHOW_MINIMAP_BUTTON"] = "Minimap-Knopf anzeigen"
...
L["SHOW_USE_ITEM_BUTTONS"] = "Knöpfe für Questgegenstände"
L["SHOW_TARGET_BUTTONS"] = "Knöpfe zum Ziel anvisieren"
...
L["TARGET_1"] = "Ziel anvisieren 1 (bzw. eines der angegebenen Ziele anvisieren)"
L["TOOLTIP_HINT_KEY_BIND_BUTTON"] = "Tipp: Du kannst diesem Knopf eine Taste zuweisen"
L["TYPE"] = "Art"
L["URL"] = "URL"
L["USE_ITEM_X"] = "Verwende Gegenstand (oder Zauberspruch) %d"
L["DATA_SOURCE_DB"] = "Interne Quest-Datenbank verwenden"
L["DATA_SOURCE_TOOLTIP_DB"] = "Für Information wie Quest-Koordinaten wird nur die in Guidelime enhaltene Quest-Datenbank genutzt.\nIn dieser können neuere Quests fehlen."
L["DATA_SOURCE_QUESTIE"] = "'Questie' als Datenquelle verwenden"
L["DATA_SOURCE_TOOLTIP_QUESTIE"] = [=[Wenn das Addon 'Questie' installiert ist, kann dieses als Datenquelle für Quest-Koordinaten genutzt werden.
...
L["ERROR_TBC_DATA_SOURCE"] = "Um diesen Guide laden zu können ist ein zusätzliches Addon als Quest-Datenquelle erforderlich. Bitte wählen in den Optionen 'Questie' oder 'ClassicCodex' als Datenquelle aus."
L["ERROR_TBC_DATA_SOURCE_INSTALL"] = "Um diesen Guide laden zu können ist ein zusätzliches Addon als Quest-Datenquelle erforderlich. Bitte installiere 'Questie' oder 'ClassicCodex'."
...
L["AUTO_TURNIN_QUESTS"] = "Rendre automatiquement les quêtes"
L["AVAILABLE_GUIDES"] = "Guides disponibles"
L["CATEGORY"] = "Catégorie "
L["CURRENT_GUIDE"] = "Guide actuel"
L["CURRENT_QUESTS"] = "dans les étapes en cours"
L["CUSTOM_GUIDES"] = "Guides personnalisés"
L["DATA_SOURCE_CLASSIC_CODEX"] = "Utiliser \"ClassicCodex\" comme base de données de quêtes interne"
L["DATA_SOURCE_DB"] = "Utiliser la base de données de quêtes interne de Guidelime"
L["DATA_SOURCE_QUESTIE"] = "Utiliser \"Questie\" comme base de données de quêtes interne"
L["DATA_SOURCE_TOOLTIP_CLASSIC_CODEX"] = "Quand l'addon \"ClassicCodex\" est installé, il peut être utilisé comme source de données pour les coordonnées de quêtes. Il peut contenir plus de données que la base de données interne de quêtes de Guidelime avec par exemple les emplacements de spawn de mobs de quêtes."
L["DATA_SOURCE_TOOLTIP_QUESTIE"] = "Quand l'addon \"Questie\" est installé, il peut être utilisé comme source de données pour les coordonnées de quêtes. Il peut contenir plus de données que la base de données interne de quêtes de Guidelime avec par exemple les emplacements de spawn de mobs de quêtes."
...
L["GUIDE_QUESTS"] = "dans le guide en cours"
...
L["SHOW_GUIDE_TITLE"] = "Afficher le titre du guide"
...
L["SKIPPING_QUEST"] = "Vous sautez cette quête."
...
L["AT"] = "в "
L["AUTO_ACCEPT_QUESTS"] = "Автоматически принимать задания"
L["AUTO_TURNIN_QUESTS"] = "Автоматически сдавать задания"
...
L["TYPE"] = "Тип"
L["URL"] = "URL"
L["DATA_SOURCE_DB"] = "Использовать внутреннюю базу данных"
L["DATA_SOURCE_QUESTIE"] = "Использовать 'Questie' как базу данных"
L["DATA_SOURCE_TOOLTIP_QUESTIE"] = [=[Если установлен 'Questie', его можно использовать в качестве источника данных для координат заданий. Он может содержать информацию, отличную от внутренней базы данных заданий, например для мест появления нпц.
]=]
L["DATA_SOURCE_CLASSIC_CODEX"] = "Использовать 'ClassicCodex' как базу данных"
L["DATA_SOURCE_TOOLTIP_CLASSIC_CODEX"] = [=[Если установлен 'ClassicCodex', его можно использовать в качестве источника данных для координат заданий. Он может содержать информацию, отличную от внутренней базы данных заданий, например для мест появления нпц.
]=]
...
L["AT"] = "a"
L["AUTO_ACCEPT_QUESTS"] = "Automáticamente aceptar misiones"
L["AUTO_TURNIN_QUESTS"] = "Automáticamente entregar misiones"
...
L["TYPE"] = "tipo"
L["URL"] = "URL"
L["DATA_SOURCE_DB"] = "Usar fuente de datos interna"
L["DATA_SOURCE_QUESTIE"] = "Usar 'Questie' como fuente de datos"
L["DATA_SOURCE_TOOLTIP_QUESTIE"] = "Cuando se instala el complemento 'Questie', se puede utilizar como fuente de datos para las coordenadas de misiones. Puede contener información diferente a la base de datos de búsqueda interna, p. Ej. para el spawn de los mobs de las misiones.."
L["DATA_SOURCE_CLASSIC_CODEX"] = "Usar 'ClassicCodex' como fuente de datos"
L["DATA_SOURCE_TOOLTIP_CLASSIC_CODEX"] = "Cuando se instala el complemento 'ClassicCodex', se puede utilizar como fuente de datos para las coordenadas de misiones. Puede contener información diferente a la base de datos de búsqueda interna, p. Ej. para el spawn de los mobs de las misiones.."
