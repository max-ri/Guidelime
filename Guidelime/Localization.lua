...
L["Alliance"] = "联盟"
L["ARROW"] = "箭头"
>>>>>>> 3757ac9a03fade3a05534f34fba5757e21635597
L["ARROW_ALPHA"] = "箭头透明度"
L["ARROW_STYLE"] = "箭头样式"
L["ARROW_STYLE1"] = "青柠"
L["ARROW_STYLE2"] = "箭头"
...
L["STEP_FOLLOWUP_QUEST_CONT"] = "如果之后你重新回来做 %s，这个任务的步骤会再度出现在指南里。"
L["STEP_FOLLOWUP_QUESTS_CONT"] = "如果之后你重新回来做 %s，这些任务的步骤会再度出现在指南里。"
...
L["MAIN_FRAME_SHOW_SCROLLBAR"] = "顯示捲動條"
L["RESET_POSITION"] = "重置位置"
L["SELECT_COLORS"] = "顏色"
...
L["STEP_FOLLOWUP_QUEST"] = "若跳過 %s 將會錯過下列任務"
L["STEP_FOLLOWUP_QUEST_CONT"] = "當您執行 ％s 之後，此任務將重新啟動。"
L["STEP_FOLLOWUP_QUESTS"] = "若跳過 %s 將會錯過下列任務"
L["STEP_FOLLOWUP_QUESTS_CONT"] = "當您執行 ％s 之後，這些任務將重新啟動。"
L["STEP_MANUAL"] = "如果完成此步驟，點擊這裡"
L["STEP_SKIP"] = "點擊這裡跳過此步驟"
...
L["USE_QUESTIE_AS_DATA_SOURCE_TOOLTIP"] = "若同時啟用Questie，可以將之作為任務座標資料庫，但它可能會提供與內建資料庫不同的資訊，例如任務怪的重生點。"
L["USE_INTERNAL_DATA_SOURCE"] = "使用內部數據庫"
L["ADD_QUEST_COORDINATES"] = "添加任務座標"
L["ADD_QUEST_COORDINATES_MESSAGE"] = "如果數據庫中有任務座標，將它們添加到所有步驟內；這會取代目前指南內的任務座標。"
L["ADDED_QUEST_COORDINATES_MESSAGE"] = "已添加%s的任務座標。"
