...
*This is for WoW Classic. It will not run on private servers and/or retail. (If you only want to take a look at the editor e.g., it will load on retail if you select "load out of date addons".)*
